...
from ..views import CheeseDetailView, CheeseListView, CheeseUpdateView
...
def test_good_cheese_list_view_expanded(rf):
    ...
    # callable_obj is analogous to function-based view
    ...
    # Test that HTTP response has 'Cheese List' in the
...
def test_good_cheese_detail_view(rf, cheese):
    ...
    # Use the reqeust to get the response
...
def test_cheese_create_form_vaild(client, user):
...
def test_cheese_create_correct_tile(client, user):
